...
'                                                                                                  '
'   input_array:                                                                                   '
'     Array(10,"vodka","beer","water",12,"soda","beer","applejuice",12)                            '
'   result_array:                                                                                  '
'     Array(10,"vodka","beer","water",12,"soda","applejuice")                                      '
'--------------------------------------------------------------------------------------------------'
'                                                                                                  '
'     Sub TestArrayUnique                                                                          '
'         Dim item As Variant                                                                      '
...
'         result = ""                                                                              '
'         uniqarr = ArrayUnique(Array(10,"vodka","beer","water",12,"soda","beer","applejuice",12)) '
