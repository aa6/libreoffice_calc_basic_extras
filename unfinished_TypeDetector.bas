Function DuplicateRow_ObjectType(TestObject as Variant, Optional TestCase As String)
    ...
    Select Case TRUE
      Case IsMissing(TestCase)
          ...
          Else
              DuplicateRow_ObjectType = DuplicateRow_ObjectType(test_object,"ImpossibleObject")
          End If      
      Case TestCase = "ImpossibleObject"
          ...
          DuplicateRow_ObjectType =  DuplicateRow_ObjectType(test_object,"Cell")
      Case TestCase = "Cell"
          ...
          DuplicateRow_ObjectType =  DuplicateRow_ObjectType(test_object,"Unknown")
      Case Else
